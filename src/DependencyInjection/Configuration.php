            ...
            ->children()
                ...
                ->arrayNode('plugins')
                    ...
                    ->children()
                        ->booleanNode('mermaid')
                            ->defaultFalse()
                            ->info('Mermaid diagrams (requires @diplodoc/mermaid-extension)')
                        ->end()
                        ->booleanNode('latex')
                            ->defaultFalse()
                            ->info('LaTeX/Math formulas (requires @diplodoc/latex-extension)')
                        ->end()
                        ->booleanNode('html')
                            ->defaultFalse()
                            ->info('HTML blocks (requires @diplodoc/html-extension)')
                        ->end()
                    ->end()
                ->end()
            ->end()
